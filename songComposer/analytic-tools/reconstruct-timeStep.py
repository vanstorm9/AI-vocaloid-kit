        ...
        for eventInd in range(0,numOfEvents):
                ...
                if eventType == 'DeltaTime':
                    ...
                    for i in range(0,int(deltaTime/3)):
                        ...
                        MyMIDI.addNote(track=tracksNum, channel=channel, pitch=0, time=count, duration=duration, volume=0)
                        saveStr = 'track: ' + str(tracksNum) + '  channel: ' + str(channel) + '  pitch: ' + str(0) + '  duration: ' + str(duration)  + '  time: ' + str(count) + '\n'
                        f.write(saveStr)
                        count += 1
